...
namespace GameCoClassLibrary.Third_Party.PriorityQueue
{
  /// <summary>
  ...
  public class PriorityQueue<TPriority, TValue> : ICollection<KeyValuePair<TPriority, TValue>>
  {
    ...
    /// </summary>
    /// <param name="item">The object to remove from the ICollection <see cref="T:System.Collections.Generic.ICollection`1"/>. </param>
